import {Box, Typography, FormControl, FormHelperText, TextField, TextareaAutosize, Stack, Select, MenuItem, Button, fontSize, borderRadius, fontWeight} from '@pankod/refine-mui'
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
        ...
        >
          ...
          <FormControl>
            ...
            <TextareaAutosize minRows={5} required placeholder='Write Description' color='info' style={{ width: '100%', background: 'transparent', fontSize: '16px', borderColor: 'rgba(0, 0, 0, 0,23)', borderRadius: 6, padding: 10, }} {...register('description', { required: true })} />
          </FormControl>
          ...
          <Stack direction="row" gap={4}>
            <FormControl>
              ...
              <Select variant='outlined' color='info' displayEmpty required inputProps={{ 'aria-label': 'Without label' }} defaultValue='apartment' {...register('propertyType', { required: true })}>
                ...
                <MenuItem value='mainsion'>Mansion</MenuItem>
