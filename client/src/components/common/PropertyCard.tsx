...
const PropertyCard = ({id, title, location, price,photo}: PropertyCardProps) => {
  return (
    <Card
        ...
        sx={{maxWidth:'330px', padding:'10px', '&:hover':{boxShadow: '0. 22px 45px 2px rgba(176, 176, 176, 0.1)'}, cursor:'pointer'}}
        elevation={0}
        >
          <CardMedia component='img' width='100%' height={210} image={photo} alt='card iamge' sx={{borderRadius: '10px'}}/>
