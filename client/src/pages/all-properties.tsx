...
const AllProperties = () => {
    ...
    // initializing the useTable below
    const {
...
// console.log(data);
    ...
    // Now to get all properties
    const allProperties = data?.data ?? []
    // what the above means is dat if we can't find the data, it should default to an empty array
          ...
          <Box display='flex' gap={2} mt={3} flexWrap='wrap'>
              <CustomButton
                ...
                <Select variant='outlined'
                    ...
                    {[10, 20, 30, 40, 50].map((size)=>(<MenuItem 
                                                        key={size} value={size}>Show {size}
                                                      </MenuItem>))}
                 </Select>
